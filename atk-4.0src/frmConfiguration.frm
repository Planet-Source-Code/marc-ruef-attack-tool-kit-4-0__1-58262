...
Begin VB.Form frmConfiguration 
   ...
   Begin VB.Frame fraPreferences 
      ...
      Begin VB.Frame fraSafety 
         ...
         Begin VB.Label lblLabel 
            Caption         =   $"frmConfiguration.frx":0CCA
            Height          =   495
            Index           =   4
            Left            =   480
            TabIndex        =   72
         ...
         End
         Begin VB.Label lblLabel 
            Caption         =   $"frmConfiguration.frx":0D70
            Height          =   495
            Index           =   3
            Left            =   480
            TabIndex        =   71
   ...
   Begin VB.Frame fraLogs 
      ...
      Begin VB.ComboBox cmbLogsSecurityLevel 
         Height          =   315
         ItemData        =   "frmConfiguration.frx":0E16
         Left            =   1320
         List            =   "frmConfiguration.frx":0E18
      ...
      End
      Begin VB.Label lblLabel 
         Caption         =   $"frmConfiguration.frx":0E1A
         Height          =   615
         Index           =   15
         Left            =   360
         TabIndex        =   27
   ...
   Begin VB.Frame fraHelp 
      ...
      Begin VB.Label lblOnlineHelpURLTest 
         ...
         Height          =   195
         Left            =   2145
         MouseIcon       =   "frmConfiguration.frx":0EF5
      ...
      End
      Begin VB.Label lblLabel 
         Caption         =   $"frmConfiguration.frx":11FF
         Height          =   615
         Index           =   19
         Left            =   120
         TabIndex        =   45
   ...
   Begin VB.Frame fraSpeech 
      ...
      Begin VB.Label lblTestSpeechFeature 
         ...
         Height          =   195
         Left            =   2400
         MouseIcon       =   "frmConfiguration.frx":12BA
         MousePointer    =   99  'Custom
         TabIndex        =   52
         Top             =   1680
         Width           =   1755
      End
      Begin VB.Label lblLabel 
         Caption         =   $"frmConfiguration.frx":15C4
         Height          =   615
         Index           =   18
         Left            =   480
         TabIndex        =   32
   ...
   Begin VB.Frame fraReports 
      ...
      Begin VB.Label lblReportTemplateNote 
         ...
         Height          =   255
         Left            =   1560
         MouseIcon       =   "frmConfiguration.frx":16B8
         MousePointer    =   99  'Custom
         TabIndex        =   29
         Top             =   3000
         Width           =   4935
   ...
   Begin VB.Frame fraSearchengine 
      ...
      Begin VB.Label lblSearchEngineTest 
         ...
         Height          =   195
         Left            =   645
         MouseIcon       =   "frmConfiguration.frx":19C2
         MousePointer    =   99  'Custom
         TabIndex        =   49
         Top             =   1440
         Width           =   5325
